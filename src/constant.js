...
import logoBlue from './assets/company_logo/logoBlue.png';
...
export const SkillsInfo = [
  ...
  export const experiences = [
    ...
    // },
    {
      ...
      desc: "Worked as a Web Developer Intern, designing and implementing scalable UI components and responsive websites using HTML, CSS, JavaScript, React, Next JS, Tailwind, and Material UI. Collaborated with the design team to translate wireframes and prototypes from Figma into interactive, user-friendly web pages.",
      skills: [
        "HTML",
        "CSS",
        "JavaScript",
